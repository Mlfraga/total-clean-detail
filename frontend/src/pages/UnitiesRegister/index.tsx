  ...
  const handleSubmit = useCallback(async (data: FormData, {reset}) => {
    try{
      ...
      const schema = Yup.object().shape({
        ...
        unitTelephone: Yup.string().required('Telefone da unidade obrigatório').min(9, 'O telefone deve ter no mínimo 9 dígitos').max(11, 'O telefone deve ter no máximo 11 dígitos'),
      });
